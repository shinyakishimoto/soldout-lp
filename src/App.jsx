  ...
  const services = [
    {
      ...
      icon: <MousePointer2 className="w-8 h-8 text-[#F26522]" />
    },
    {
      title: 'SEO・コンテンツ制作',
      desc: '検索エンジンからの流入を最大化し、ブランドの信頼性を高めるコンテンツを提供。',
      icon: <BarChart2 className="w-8 h-8 text-[#F26522]" />
    },
    {
      title: 'DX支援・ツール導入',
      desc: '営業効率化やデータ活用など、企業のデジタル変革をトータルでサポート。',
      icon: <Globe className="w-8 h-8 text-[#F26522]" />
    }
  ];

  return (
    <div className="min-h-screen bg-[#FCFCFC] text-gray-900 font-sans selection:bg-[#F26522] selection:text-white">
      {/* Navigation */}
        ...
        <div className="container mx-auto px-6 flex justify-between items-center max-w-7xl">
          <div className="flex items-center space-x-2 cursor-pointer">
            <span className={`text-3xl font-black tracking-tighter ${scrolled ? 'text-gray-900' : 'text-gray-900'}`}>
              SOLD<span className="text-[#F26522]">OUT</span>
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-10">
            {navLinks.map((link) => (
              <a key={link.name} href={link.href} className="text-sm font-bold text-gray-600 hover:text-[#F26522] transition-colors tracking-wide">
                {link.name}
              </a>
            ))}
            <a href="#contact" className="bg-[#F26522] text-white px-7 py-3 rounded-lg font-bold text-sm hover:bg-[#d9531e] transition-all shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 hover:-translate-y-0.5">
              お問い合わせ
            </a>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-xl border-t border-gray-100 absolute w-full shadow-2xl">
            <div className="flex flex-col p-6 space-y-6">
              {navLinks.map((link) => (
                <a key={link.name} href={link.href} className="text-lg font-bold text-gray-800 hover:text-[#F26522]" onClick={() => setIsMenuOpen(false)}>
                  {link.name}
                </a>
              ))}
              <a href="#contact" className="bg-[#F26522] text-white px-6 py-4 rounded-xl font-bold text-center shadow-lg shadow-orange-500/30" onClick={() => setIsMenuOpen(false)}>
                お問い合わせ
              </a>
            </div>
          </div>
      ...
      <section className="relative pt-40 pb-24 md:pt-56 md:pb-40 overflow-hidden">
        {/* モダンな背景装飾 */}
        <div className="absolute top-0 right-0 w-[45%] h-full bg-orange-50 rounded-bl-[120px] -z-10 hidden lg:block opacity-70"></div>
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-orange-100 rounded-full blur-3xl -z-10 opacity-50"></div>

        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 space-y-10 z-10">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white border border-gray-100 shadow-sm rounded-full text-xs font-extrabold tracking-widest text-[#F26522] uppercase">
              ...
              <h1 className="text-5xl md:text-7xl font-black text-gray-900 leading-[1.1] tracking-tight">
                中小・ベンチャーの<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F26522] to-[#ff8c52]">
                  成長を加速させる。
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-4">
                <button className="bg-[#F26522] text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#d9531e] transition-all flex items-center justify-center group shadow-xl shadow-orange-500/20 hover:shadow-orange-500/40">
                  サービスを見る
              ...
              <div className="flex items-center space-x-10 pt-8 border-t border-gray-100">
                <div>
                  <div className="text-3xl font-black text-gray-900 mb-1">3,000<span className="text-[#F26522]">+</span></div>
                  <div className="text-sm font-bold text-gray-400">累計支援社数</div>
                </div>
                <div>
                  <div className="text-3xl font-black text-gray-900 mb-1">20<span className="text-[#F26522]">+</span></div>
            ...
            <div className="lg:w-1/2 relative w-full">
              ...
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[#F26522] rounded-full -z-10 mix-blend-multiply opacity-20 blur-xl"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-2xl">
              <div className="text-[#F26522] font-bold tracking-widest text-sm mb-4 uppercase">Services</div>
            ...
            {services.map((service, idx) => (
              <div key={idx} className="bg-[#FCFCFC] p-10 rounded-3xl hover:bg-white transition-all duration-300 border border-gray-100 hover:border-gray-200 hover:shadow-2xl hover:shadow-gray-200/50 group">
                <div className="bg-white border border-gray-100 shadow-sm w-16 h-16 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
                  {React.cloneElement(service.icon, { className: "w-8 h-8 group-hover:text-[#F26522] transition-colors" })}
                </div>
                ...
                <a href="#" className="inline-flex items-center text-sm font-bold text-gray-900 group-hover:text-[#F26522] transition-colors">
      ...
      <section id="strengths" className="py-32 bg-gray-900 text-white overflow-hidden relative">
        ...
        <div className="absolute top-20 right-20 text-[#F26522] opacity-5">
           <Users size={400} />
        </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="flex flex-col lg:flex-row gap-20">
            <div className="lg:w-1/2">
              <div className="text-[#F26522] font-bold tracking-widest text-sm mb-4 uppercase">Our Strengths</div>
              <h2 className="text-4xl md:text-5xl font-black mb-12 leading-tight tracking-tight">
                なぜ、ソウルドアウトが<br />選ばれるのか
              </h2>
              <div className="space-y-12">
                <div className="flex gap-6 group">
                  <div className="flex-shrink-0 w-14 h-14 bg-gray-800 text-[#F26522] rounded-2xl flex items-center justify-center font-black text-xl group-hover:bg-[#F26522] group-hover:text-white transition-colors duration-300">01</div>
                  <div>
                ...
                <div className="flex gap-6 group">
                  <div className="flex-shrink-0 w-14 h-14 bg-gray-800 text-[#F26522] rounded-2xl flex items-center justify-center font-black text-xl group-hover:bg-[#F26522] group-hover:text-white transition-colors duration-300">02</div>
                  <div>
                ...
                <div className="flex gap-6 group">
                  <div className="flex-shrink-0 w-14 h-14 bg-gray-800 text-[#F26522] rounded-2xl flex items-center justify-center font-black text-xl group-hover:bg-[#F26522] group-hover:text-white transition-colors duration-300">03</div>
                  <div>
            ...
            <div className="lg:w-1/2 flex items-center">
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-[2rem] p-10 md:p-14 relative w-full">
                <MessageSquare className="w-12 h-12 text-[#F26522] mb-8" />
      ...
      {/* CTA Section */}
      <section id="contact" className="py-32 bg-[#F26522] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6">
            ...
            <div className="flex items-center gap-4 text-left border-l-0 md:border-l-2 border-orange-400 pl-0 md:pl-8 py-2">
              <div className="bg-white/20 p-4 rounded-full backdrop-blur-sm">
                <Phone className="w-6 h-6" />
              </div>
              <div>
                <div className="text-sm text-orange-200 font-bold mb-1">お電話でのご相談</div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid md:grid-cols-12 gap-12 mb-20">
            <div className="col-span-1 md:col-span-4">
              ...
              <div className="flex space-x-3">
                <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-gray-600 hover:bg-[#F26522] hover:text-white cursor-pointer transition-all border border-gray-100">
                  <Globe size={20} />
                </div>
                <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-gray-600 hover:bg-[#F26522] hover:text-white cursor-pointer transition-all border border-gray-100">
                  <Mail size={20} />
            ...
            <div className="col-span-1 md:col-span-2 md:col-start-6">
              ...
              <ul className="space-y-4 font-medium text-gray-500">
                <li><a href="#" className="hover:text-[#F26522] transition-colors">Web広告運用</a></li>
                <li><a href="#" className="hover:text-[#F26522] transition-colors">コンテンツマーケティング</a></li>
                <li><a href="#" className="hover:text-[#F26522] transition-colors">DXコンサルティング</a></li>
                <li><a href="#" className="hover:text-[#F26522] transition-colors">EC支援サービス</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <ul className="space-y-4 font-medium text-gray-500">
                <li><a href="#" className="hover:text-[#F26522] transition-colors">会社概要</a></li>
                <li><a href="#" className="hover:text-[#F26522] transition-colors">代表メッセージ</a></li>
                <li><a href="#" className="hover:text-[#F26522] transition-colors">採用情報</a></li>
                <li><a href="#" className="hover:text-[#F26522] transition-colors">ニュースリリース</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-1 md:col-span-3">
              ...
              <ul className="space-y-5 font-medium text-gray-500">
                <li className="flex items-start gap-4">
                  <MapPin size={20} className="text-[#F26522] mt-0.5 flex-shrink-0" />
                  <span className="leading-relaxed">東京都文京区後楽1-4-14<br/>後楽森ビル19F</span>
                </li>
                <li className="flex items-center gap-4">
                  <Phone size={20} className="text-[#F26522] flex-shrink-0" />
                  <span>03-xxxx-xxxx</span>
                </li>
                <li className="flex items-center gap-4">
                  <Mail size={20} className="text-[#F26522] flex-shrink-0" />
          ...
          <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center text-sm font-medium text-gray-400">
            ...
            <div className="flex space-x-8 mt-6 md:mt-0">
              <a href="#" className="hover:text-[#F26522] transition-colors">プライバシーポリシー</a>
              <a href="#" className="hover:text-[#F26522] transition-colors">サイト利用規約</a>
            </div>
          </div>
        </div>
      </footer>
